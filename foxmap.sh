...
# Trap the SIGINT signal and call the stop function
trap 'stop' 2
...
banner() {
    ...
    # Define the lines to be centered
    lines=(
        "░▒▓████████▓▒░▒▓██████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓██████████████▓▒░ ░▒▓██████▓▒░░▒▓███████▓▒░  "
        "░▒▓█▓▒░     ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ "
        "░▒▓█▓▒░     ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ "
        ...
        "▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀"
        " "
        "FOXMAP ver 1.0 - [WH04M1i]"
        "www.foxfoster.com | youtube.com/@G0V3RDH4N"
        "FOXMAP is a simple and light tool for information gathering and capturing GPS coordinates."
        " "
    )
    ...
    for line in "${lines[@]}"; do
        if [[ "$line" == "FOXMAP ver 1.0 - [WH04M1i]" ]]; then
            printf "\e[1;93m"
        elif [[ "$line" == "www.foxfoster.com | youtube.com/@G0V3RDH4N" ]]; then
            printf "\e[1;92m"
        elif [[ "$line" == "FOXMAP is a simple and light tool for information gathering and capturing GPS coordinates." ]]; then
            printf "\e[1;90m"
        else
            printf "\e[0m"  # Reset color for non-highlighted lines
        fi
        print_centered "$line"
